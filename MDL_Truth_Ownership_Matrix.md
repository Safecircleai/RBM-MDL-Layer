...
| **Risk** (risk scoring of behavior) | — | **Governance Supervisor** and/or **Intelligence Consumer** — *not* MDL | Intelligence Consumer (and the Governance Supervisor's own oversight, outside MDL) | Supervisor / Intelligence (their own models) | MDL domain (surfaces facts, not risk verdicts) |
